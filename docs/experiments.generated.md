...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Sequential Index | core | zip-sequential | 1.00 | 0.89 | 0.611 | 6.111 | 0.917 | 0.004 | 10.0 | 2.0 |
| Greedy Nearest Timestamp | experiment | cursor-nearest | 0.67 | 1.00 | 0.167 | 1.667 | 0.167 | 0.019 | 6.0 | 5.0 |
| Timeline Interpolation | core | timeline-interpolated | 0.67 | 1.00 | 0.000 | 0.000 | 0.000 | 0.020 | 10.0 | 8.0 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Conservative Simple | experiment | fallback-first | 1.00 | 0.75 | 0.863 | 0.001 | 3.8 | 7.0 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Strict Content Gate | experiment | single-branch | 0.50 | 1.00 | 1.00 | 1.00 | 0.045 | 10.0 | 0.0 |
| Fallback Cascade | experiment | json-then-text | 0.75 | 1.00 | 1.00 | 1.00 | 0.033 | 7.6 | 3.0 |
| Suffix-Aware Repair | core | hinted-repairing | 1.00 | 1.00 | 1.00 | 1.00 | 0.043 | 2.0 | 9.0 |
...
- Fastest median runtime: `Fallback Cascade`
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Strict Canonical | experiment | exact-contract | 0.33 | 1.00 | 1.000 | 0.023 | 10.0 | 2.0 |
| Linked Capture Fallback | experiment | capture-aware | 0.67 | 1.00 | 1.000 | 0.017 | 10.0 | 5.0 |
| Alias Friendly | core | compatibility-first | 1.00 | 1.00 | 1.000 | 0.015 | 10.0 | 10.0 |
...
| Policy | Tier | Style | Success | Exact | Shape | Runtime (ms) | Readability | Extensibility |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Ignore Orphaned | experimental | minimal | 1.00 | 0.33 | 0.333 | 0.002 | 10.0 | 2.0 |
| Cancel Requested Only | experimental | targeted | 1.00 | 0.67 | 0.667 | 0.003 | 9.8 | 4.5 |
| Cancel Source Backlog | core | source_scoped | 1.00 | 1.00 | 1.000 | 0.003 | 5.2 | 7.5 |
...
| Policy | Tier | Style | Success | Exact | Shape | Runtime (ms) | Readability | Extensibility |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Keep All | experimental | append_only | 1.00 | 0.33 | 0.556 | 0.004 | 10.0 | 2.0 |
| Exact Render Drop New | experimental | exact_dedupe | 1.00 | 0.33 | 0.444 | 0.004 | 7.8 | 4.5 |
| Latest Render Per Source | core | latest_render | 1.00 | 1.00 | 1.000 | 0.004 | 6.6 | 7.5 |
...
| Policy | Tier | Style | Success | Exact | Shape | Runtime (ms) | Readability | Extensibility |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Literal Passthrough | experimental | literal | 1.00 | 0.40 | 0.800 | 0.003 | 10.0 | 5.5 |
| Structured Codes | core | canonical | 1.00 | 1.00 | 1.000 | 0.004 | 7.8 | 5.5 |
| Action Hint | experimental | actionable | 1.00 | 0.00 | 0.667 | 0.003 | 3.1 | 5.0 |
...
| Policy | Tier | Style | Success | Match | Fitness | Runtime (ms) | Readability | Extensibility |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Explicit Only | experiment | manual-first | 1.00 | 0.80 | 0.910 | 0.002 | 1.0 | 5.0 |
| Balanced Interactive Transport | core | workload-aware | 1.00 | 1.00 | 1.000 | 0.003 | 10.0 | 10.0 |
| Browser First | experiment | browser-priority | 1.00 | 0.80 | 0.910 | 0.002 | 2.0 | 7.0 |
...
- Fastest median runtime: `Explicit Only`
...
| Policy | Tier | Style | Success | Exact | Shape | Runtime (ms) | Readability | Extensibility |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Strict Schema | experiment | exact-contract | 0.40 | 1.00 | 1.000 | 0.027 | 4.6 | 2.0 |
| Envelope First | experiment | wrapper-oriented | 0.80 | 1.00 | 1.000 | 0.028 | 1.4 | 7.5 |
| Alias Friendly | core | compatibility-first | 1.00 | 1.00 | 1.000 | 0.028 | 1.0 | 10.0 |
...
| Policy | Tier | Style | Success | Exact | Shape | Runtime (ms) | Readability | Extensibility |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| FIFO Unbounded | experimental | fifo | 1.00 | 0.33 | 0.533 | 0.011 | 9.1 | 0.0 |
| Bounded FIFO | experimental | fifo_bounded | 1.00 | 0.33 | 0.467 | 0.011 | 9.1 | 2.5 |
| Interactive First | core | priority_bounded | 1.00 | 1.00 | 1.000 | 0.015 | 5.7 | 8.0 |
...
| Policy | Tier | Style | Success | Exact | Shape | Runtime (ms) | Readability | Extensibility |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Serial Only | experimental | opaque | 1.00 | 0.00 | 0.000 | 0.003 | 10.0 | 0.0 |
| Endpoint Scoped | experimental | endpoint_scoped | 1.00 | 0.33 | 0.333 | 0.017 | 10.0 | 2.5 |
| Remote Observable | core | connection_observable | 1.00 | 1.00 | 1.000 | 0.006 | 7.8 | 7.5 |
...
| Policy | Tier | Style | Success | Exact | Shape | Runtime (ms) | Readability | Extensibility |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Fixed Deadline | experimental | fixed | 1.00 | 0.00 | 0.533 | 0.005 | 8.8 | 0.0 |
| Hint Bounded | experimental | hint_driven | 1.00 | 0.33 | 0.600 | 0.005 | 7.6 | 2.5 |
| Workload Aware Retry | core | adaptive | 1.00 | 1.00 | 1.000 | 0.008 | 2.0 | 8.0 |
...
- Fastest median runtime: `Fixed Deadline`
...
| Policy | Tier | Style | Success | Exact | Shape | Runtime (ms) | Readability | Extensibility |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Minimal Envelope | experimental | minimal | 1.00 | 0.33 | 0.712 | 0.001 | 7.6 | 2.0 |
| Browser Observable | core | canonical | 1.00 | 1.00 | 1.000 | 0.002 | 4.8 | 7.0 |
| Diagnostic Meta | experimental | telemetry_rich | 1.00 | 0.00 | 0.739 | 0.003 | 8.1 | 10.0 |
...
| Policy | Tier | Style | Success | Exact | Shape | Runtime (ms) | Readability | Extensibility |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Strict Canonical | experiment | exact-contract | 0.40 | 1.00 | 1.000 | 0.008 | 4.4 | 2.0 |
| Wrapped Pose | experiment | wrapper-oriented | 0.60 | 1.00 | 1.000 | 0.005 | 1.0 | 4.5 |
| Alias Friendly | core | compatibility-first | 1.00 | 1.00 | 1.000 | 0.007 | 1.0 | 10.0 |
...
- Best policy fit: `Alias Friendly`
- Fastest median runtime: `Wrapped Pose`
- Most readable implementation: `Strict Canonical`
- Broadest extension surface: `Alias Friendly`
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Strict Canonical | experiment | exact-contract | 0.33 | 1.00 | 1.00 | 0.016 | 8.6 | 2.0 |
| Response Pose Fallback | experiment | response-oriented | 1.00 | 0.89 | 1.00 | 0.017 | 8.6 | 5.0 |
| Route Aware | core | bundle-aware | 1.00 | 1.00 | 1.00 | 0.017 | 8.2 | 8.0 |
...
| Envelope First | experiment | wrapper-oriented | 0.60 | 1.00 | 1.000 | 0.003 | 8.2 | 4.5 |
