...
`3d-gaussian-splatting`, `3dgs`, `slam`, `visual-slam`, `robotics`, `physical-ai`, `simulation`, `benchmark`, `autonomous-driving`, `mast3r`, `dust3r`, `vggt-slam`, `gsplat`, `scenario-ci`, `route-policy-benchmark`, `webgl`, `webgpu`
